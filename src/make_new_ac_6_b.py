...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,machine_type,isInterlayer):
    ...
    if a_>b_:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,0,A1,A2,A3, phi1,phib)
        ...
        monomer_array_p1 = get_monomer_xyzR(monomer_name,a_,0,0,A1,A2,A3, phi1,phib)
    ...
    monomer_array_t1 = get_monomer_xyzR(monomer_name,a_/2,b_/2,0,-A4,A2,-A3, phi2,phib)
    monomer_array_t2 = get_monomer_xyzR(monomer_name,a_/2,-b_/2,0,-A4,A2,-A3, phi2,phib)
    monomer_array_t3 = get_monomer_xyzR(monomer_name,-a_/2,-b_/2,0,-A4,A2,-A3, phi2,phib)
    monomer_array_t4 = get_monomer_xyzR(monomer_name,-a_/2,b_/2,0,-A4,A2,-A3, phi2,phib)
