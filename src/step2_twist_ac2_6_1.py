...
def listen(args):
    ...
    isTest = args.isTest
    fixed_param_keys = ['a','A1','A2','phi','theta']
    opt_param_keys = ['b']
...
def get_opt_params_dict(df_cur, init_params_dict,fixed_params_dict):
    ...
    a = init_params_dict['a']; b_init_prev = init_params_dict['b']
    A1 = init_params_dict['A1']; A2 = init_params_dict['A2']; theta = init_params_dict['theta'];phi = init_params_dict['phi']
    
    while True:
        E_list=[];heri_list=[]
        for b in [b_init_prev-0.2,b_init_prev,b_init_prev+0.2]:
            ...
            if len(df_val_ab)==0:
                return False,{'b':b}
            heri_list.append(b);E_list.append(df_val_ab['E'].values[0])
        b_init = heri_list[np.argmin(np.array(E_list))]
        if  b_init==b_init_prev:
            return True,{'b':b_init}
        else:
            b_init_prev=b_init
