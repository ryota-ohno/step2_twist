...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,machine_type,isInterlayer):
    ...
    monomer_array_i1 = get_monomer_xyzR(monomer_name,0,0,0,A1,A2,A3, phi1)
    monomer_array_i2 = get_monomer_xyzR(monomer_name,0,0,0,-A4,A2,-A3, phi2)
    if a_>b_:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,0,A1,A2,A3, phi1)
    ...
    monomer_array_p2 = get_monomer_xyzR(monomer_name,0,b_,0,-A4,A2,-A3, phi2)
    ...
    monomer_array_it4 = get_monomer_xyzR(monomer_name,c[0]-a_/2,c[1]+b_/2,c[2],-A4,A2,-A3, phi2)
